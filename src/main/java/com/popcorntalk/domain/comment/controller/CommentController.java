...
public class CommentController {
    ...
    public ResponseEntity<CommonResponseDto<Void>> createComment(@AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable Long postId,@RequestBody CommentCreateRequestDto requestDto){
